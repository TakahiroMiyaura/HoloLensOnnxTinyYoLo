...
namespace UWPOnnxTinyYoloV2.Common.Yolo9000
{
    public class YoloWinMlParser
    {
        ...
        public IList<YoloBoundingBox> ParseOutputs(float[] yoloModelOutputs, float threshold = .3F)
        {
            ...
            var featuresPerBox = BoxInfoFeatureCount + ClassCount;
            var stride = featuresPerBox * BoxesPerCell;
            ...
            for (var b = 0; b < BoxesPerCell; b++)
            {
                ...
                var x = (cx + Sigmoid(tx)) * CellWidth;
                var y = (cy + Sigmoid(ty)) * CellHeight;
